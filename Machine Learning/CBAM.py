...
class CBAM(nn.Module):
    def __init__(self):
        ...
        self.channel = common.ChannelAttention(in_planes=16,activate_type="silu")
        self.spatial = common.SpatialAttention()
...
model_path = r"save_model\CBAM-30.pth"
mFida = torch.load(model_path)
acc_list, total_acc_list, erro_list = [], [], []
