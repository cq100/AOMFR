...
class Dataset(object):
    def __init__(self,train_ds,batch_size,device=None,shuffle=True):
        ...
        self.batch_count = 0
        self.size_array = np.arange(32,65,step=4)      #9个随机缩放大小
...
class MFIDA(nn.Module):
    def __init__(self):
        ...
        self.CBL1 = nn.Sequential(nn.Conv2d(in_channels=3, out_channels=36, kernel_size=3, stride=2, padding=1, groups=1, bias=False),
                                nn.BatchNorm2d(36),
