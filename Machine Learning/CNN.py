...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.CBS1 = common.Tconvolutional(filters_shape=(3, 3, 3, 64), downsample=True, activate_type="silu")
        self.CBS2 = common.Tconvolutional(filters_shape=(3, 3, 64, 32), downsample=True, activate_type="silu")
        self.CBS3 = common.Tconvolutional(filters_shape=(3, 3, 32, 8), downsample=True, activate_type="silu")
...
model_path = r"save_model\CNN-44.pth"
mFida = torch.load(model_path)
acc_list, total_acc_list, erro_list = [], [], []
